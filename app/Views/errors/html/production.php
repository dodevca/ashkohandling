...
<head>
    <meta charset="UTF-8">
    <title>Halaman Dalam Konstruksi - Amanah Sabila Handling</title>
    ...
    <header id="header">
        <nav id="navbar" class="navbar p-lg-3">
            <div class="container-fluid">
                <a href="<?= !empty($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : base_url(); ?>" class="btn btn-link">
        ...
        <section class="container-fluid">
            <div class="card border-0 mx-auto" style="max-width: 576px;">
                <div class="card-body text-dark text-center">
                    ...
                    <h1 class="h5 fw-bold">Sedang Dalam Konstruksi</h1>
                    <h2 class="h6">Halaman ini sedang dalam konstruksi. Halaman akan segera tersedia.</h2>
